        ...
        if ($slug == 'Teknik Pertambangan') {
            ...
            if ($request->isMethod('POST')) {
                ...
                $rules = [
                    ...
                    'syarat_16' => 'required|mimes:docx,doc',
                ];
                ...
                $customMessage = [
                    ...
                    'syarat_4.required' => 'Formulir nilai bimbingan skripsi harus diisi',
                    'syarat_5.required' => 'Formulir kemajuan bimbingan skripsi harus diisi',
                    'syarat_6.required' => 'Formulir persetujuan kolokium skripsi harus diisi',
                    'syarat_7.required' => 'Formulir kesediaan menghadiri kolokium skripsi harus diisi',
                    'syarat_8.required' => 'Pas foto ukuran 4 x 6 sebanyak 2 lembar harus diisi',
                    'syarat_9.required' => 'Kartu Tanda Mahasiswa harus diisi',
                    'syarat_10.required' => 'Bukti pembayaran kuliah harus diisi',
                    'syarat_11.required' => 'Bukti perwalian harus diisi',
                    'syarat_12.required' => 'Bukti bebas pinjaman perpustakaan harus diisi',
                    'syarat_13.required' => 'Sertifikat pesantren calon sarjana harus diisi',
                    'syarat_14.required' => 'Keterangan menghadiri kolokium skripsi (7 kali) harus diisi',
                    'syarat_15.required' => 'Draft skripsi (PDF) Harus Diisi',
                    'syarat_16.required' => 'Draft skripsi (DOCX) Harus Diisi',
                    ...
                    'syarat_4.mimes' => 'Format File Formulir nilai bimbingan skripsi harus PDF',
                    'syarat_5.mimes' => 'Format File Formulir kemajuan bimbingan skripsi harus PDF',
                    'syarat_6.mimes' => 'Format File Formulir persetujuan kolokium skripsi harus PDF',
                    'syarat_7.mimes' => 'Format File Formulir kesediaan menghadiri kolokium skripsi harus PDF',
                    'syarat_8.mimes' => 'Format File Pas foto ukuran 4 x 6 sebanyak 2 lembar harus PDF',
                    'syarat_9.mimes' => 'Format File Kartu Tanda Mahasiswa harus PDF',
                    'syarat_10.mimes' => 'Format File Bukti pembayaran kuliah harus PDF',
                    'syarat_11.mimes' => 'Format File Bukti perwalian harus PDF',
                    'syarat_12.mimes' => 'Format File Bukti bebas pinjaman perpustakaan harus PDF',
                    'syarat_13.mimes' => 'Format File Sertifikat pesantren calon sarjana harus PDF',
                    'syarat_14.mimes' => 'Format File Keterangan menghadiri kolokium skripsi (7 kali) harus PDF',
                    'syarat_15.mimes' => 'Format File Draft skripsi Harus PDF',
                    'syarat_16.mimes' => 'Format File Draft skripsi Harus DOCX',
                ];
                ...
                $syarat_16_path = 'mahasiswa/seminar/syarat15';
