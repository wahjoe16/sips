        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="" action="{{ route('updateProfileDosen') }}" method="post" enctype="multipart/form-data">@csrf
                        <div class="form-group row">
                            <label for="exampleInputEmail2" class="col-sm-3 col-form-label" for="nik">NIK</label>
                            <div class="col-sm-9">
                                <input type="text" name="nik" class="form-control" id="username" value="{{ Auth::guard('dosen')->user()->nik }}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInputEmail2" class="col-sm-3 col-form-label" for="nama">Nama</label>
                            <div class="col-sm-9">
                                <input type="text" name="nama" class="form-control" id="nama" value="{{ Auth::guard('dosen')->user()->nama }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="program_studi" id="program_studi" class="form-control text-dark">
                                    ...
                                    <option value="{{ $programStudi }}" {{ old("program_studi", $dosen->program_studi)==$programStudi ? "selected" : "" }}>{{ $prodiLabel }}</option>
                                    @endforeach
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="email" name="email" class="form-control" id="email" value="{{ Auth::guard('dosen')->user()->email }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInputEmail2" class="col-sm-3 col-form-label" for="telepon">Mobile Phone</label>
                            <div class="col-sm-9">
                                <input type="text" name="telepon" class="form-control" id="telepon" value="{{ Auth::guard('dosen')->user()->telepon }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <a target="_blank" href="{{ url('dosen/foto/'.Auth::guard('dosen')->user()->foto) }}">Lihat Foto</a>
                                <input type="hidden" name="current_dosen_foto" value="{{ Auth::guard('dosen')->user()->foto }}">
                                @endif
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <a href="{{ route('dashboardDosen') }}" class="btn btn-light">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
